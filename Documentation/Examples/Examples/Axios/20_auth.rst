...
.. tip::
    ...
    | Want to play, not read? Then head on to `Codepen <https://codepen.io/99grad/pen/abLwJmm>`__ and learn by playing with the example.
...
.. tip::
    ...
    | Head on to `Codepen <https://codepen.io/99grad/pen/abLwJmm>`__ and have fun!
