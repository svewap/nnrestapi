...
.. _examples_plain_auth:

============
Authentication
============

How to login as a Frontend-User using pure JS and send requests to the TYPO3 Rest Api
------------
...
.. tip::
    ...
    | Want to play, not read? Then head on to `Codepen <https://codepen.io/99grad/pen/zYEzMMg>`__ and learn by playing with the example.
...
.. tip::
    ...
    | Head on to `Codepen <https://codepen.io/99grad/pen/zYEzMMg>`__ and have fun!
