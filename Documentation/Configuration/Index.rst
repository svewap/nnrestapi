...
.. container:: table-row
   ...
   Description
        ...
        Can be a comma-seperated list of users, see :ref:`this section <access>` for more examples.
        ::
...
.. container:: table-row
   ...
   Description
        ...
        This can be done :ref:`on a per-method base <annotations_distiller>` or globally for 
...
.. container:: table-row
   ...
   Description
        ...
        These values will be overriden, if the frontend sets a value for the field.
        ...
        ::
            ...
            plugin.tx_nnrestapi.settings.kickstarts {
                myexample {
                    ...
                    // title and description for the listview
