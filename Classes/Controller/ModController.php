...
// \nn\t3::debug($url);
		$this->view->assignMultiple([
			...
			'settings' 	=> $settings,
            'link'      => [
                \nn\t3::Page()->getLink(1, ['david'=>123]),
                \nn\t3::Page()->getLink(1, ['controller'=>'controller'.time(), 'action'=>'action', 'uid'=>'1', 'param1'=>'2', 'param2'=>'3']),
                \nn\t3::Page()->getLink(1, ['controller'=>'controller'.time(), 'action'=>'action', 'uid'=>'1', 'param1'=>'2' ]),
                \nn\t3::Page()->getLink(1, ['controller'=>'controller'.time(), 'action'=>'action', 'uid'=>'1' ]),
                \nn\t3::Page()->getLink(1, ['controller'=>'controller'.time(), 'action'=>'action' ]),
                \nn\t3::Page()->getLink(1, ['controller'=>'controller'.time() ]),
                \nn\t3::Page()->getLink(1, []),
                \nn\t3::Page()->getLink(1, ['type'=>20210904, 'controller'=>'controller'.time(), 'action'=>'action', 'uid'=>'1', 'param1'=>'2', 'param2'=>'3']),
                \nn\t3::Page()->getLink(1, ['type'=>20210904, 'controller'=>'controller'.time(), 'action'=>'action', 'uid'=>'1', 'param1'=>'2' ]),
                \nn\t3::Page()->getLink(1, ['type'=>20210904, 'controller'=>'controller'.time(), 'action'=>'action', 'uid'=>'1' ]),
                \nn\t3::Page()->getLink(1, ['type'=>20210904, 'controller'=>'controller'.time(), 'action'=>'action' ]),
                \nn\t3::Page()->getLink(1, ['type'=>20210904, 'controller'=>'controller' ]),
                \nn\t3::Page()->getLink(1, ['type'=>20210904 ]),
            ]
		]);
